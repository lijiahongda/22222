...
Page({
  ...
  RecentSearch: function (e) {
    ...
    wx.navigateTo({
      url: '../searchResult/searchResult?keyWord=' + e.currentTarget.dataset.keyword + '&channelid='+that.data.channelid+'&idx='+that.data.idx,
    })
  },
  ...
  bindconfirm: function (e) {
    ...
    wx.navigateTo({
      url: '../searchResult/searchResult?keyWord=' + that.data.keyWord + '&channelid=' + this.data.channelid,
    })
  ...
  titleList: function (e) {
    let that = this
    wx.navigateTo({
      url: '../searchResult/searchResult?keyWord=' + e.currentTarget.dataset.name + '&channelid=' + this.data.channelid,
    })
    let name
