  ...
  getOrderList: function () {
    ...
    post('/mall/flashDetail', {
      ...
      if (res.data.code == 200) {
        ...
        console.log(res.data.productInfo.saleList)
        ...
        console.log('iiiii')
        wx.redirectTo({
          url: '/page/Yuemall/pages/details/details?goodsId=' + that.data.goodsId + '&skuid=' + res.data.skuId
        })
      } else {
        wx.showToast({
          title: res.data.msg,
  ...
  sure: function (e) {
    ...
    if (e.currentTarget.dataset.id == 1) { //加入购物车
      ...
      if (e.currentTarget.dataset.amountnumber == 0) {
        ...
        wx.navigateTo({
          url: '../RushBuyBalance/RushBuyBalance?Entrance=' + 'RushBuy' + '&goodsnum=' + e.currentTarget.dataset.amountnumber + '&goodid=' + e.currentTarget.dataset.goodid + '&skuid=' + that.data.skuid + '&areaid=' + that.data.address.addressId + '&activityId=' + that.data.activityId + '&type=' + that.data.type
        })
      }
    }
    that.hideModal()
